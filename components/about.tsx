        ...
        >
          ...
          <div className="flex flex-col gap-6 max-w-lg">
            <p className="font-sans text-base md:text-lg leading-relaxed text-muted-foreground">
              Product Designer focused on the intersection of complexity and clarity. I work with companies navigating digital transformation and turning fragmented legacy systems into coherent, scalable experiences.
            </p>
          </div>
